return {
  ...
  config = function()
    require("fidget").setup({
      -- Key maps for fidget
      vim.keymap.set("n", "<leader>nh", "<cmd>Fidget history<CR>", { desc = "[N]otification [H]istory" }),
      vim.keymap.set("n", "<leader>ns", "<cmd>Fidget suppress<CR>", { desc = "[N]otification [S]upress" }),
