...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions vi-mode archlinux colored-man-pages)
...
__conda_setup="$('/home/phoenix/Apps/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
